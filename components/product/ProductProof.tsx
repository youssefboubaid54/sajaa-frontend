    ...
    <div className="space-y-10 lg:space-y-12">
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-3xl p-6 sm:p-8 border border-beige shadow-soft flex flex-col items-center text-center">
          ...
          {/* Halal certificate */}
          {product.isHalal ? (
            <div className="bg-white rounded-3xl p-6 sm:p-8 border border-success/20 shadow-soft flex flex-col items-center text-center">
      ...
      <section className="bg-navy rounded-[2rem] p-7 sm:p-10 text-white text-center relative overflow-hidden">
