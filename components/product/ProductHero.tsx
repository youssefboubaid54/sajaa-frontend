        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
          ...
          <div className="lg:order-1 flex flex-col gap-5">
            ...
            <div>
              ...
              <p className="text-muted text-sm font-latin">{product.nameEn}</p>
            </div>

            {/* Pain headline */}
            <div className="bg-white border border-beige rounded-2xl p-4">
              <p className="text-navy/80 font-semibold leading-snug">
            ...
            <div className="grid grid-cols-2 gap-2">
              {TRUST_BADGES.map((b, i) => (
                <div
                  key={i}
                  className="flex items-center gap-2 text-xs text-navy/70 bg-white border border-beige rounded-xl px-3 py-2"
                >
                  <span>{b.icon}</span>
                  <span>{b.text}</span>
                </div>
